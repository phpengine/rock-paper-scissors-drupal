    ...
    <div class="playimg">
        ...
        <div class="resultfieldsetbody">
            <?php if ( $pageVars["playerChoices"]["p1"]["choice"]=="rock" ) { ?>
                <div class="playimg"><img src="sites/all/modules/gc_helloworld/Assets/images/stone.png" alt="Rock" /> </div>
            <?php } else if ( $pageVars["playerChoices"]["p1"]["choice"]=="paper" ) { ?>
                <div class="playimg"><img src="sites/all/modules/gc_helloworld/Assets/images/paper.png" alt="Paper" /> </div>
            <?php } else if ( $pageVars["playerChoices"]["p1"]["choice"]=="scissors" ) {  ?>
                <div class="playimg"><img src="sites/all/modules/gc_helloworld/Assets/images/scissors.png" alt="Scissors" /> </div>
            <?php } ?>
