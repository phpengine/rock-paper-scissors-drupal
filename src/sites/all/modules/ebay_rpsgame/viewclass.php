...
class EbayRPSGameViewClass {
	...
	*/
	private function createContentHtml() {
		...
		$htmlvar .= '<!--BEGIN .recent-wrap -->
                <div class="recent-wrap" style="text-align:center; padding-top:0px; border:none;">					                        
                        <!--BEGIN .hentry-wrap -->
                    	<div class="hentry-wrap clearfix" style="width:800px; "> 
		';
	...
	*/
	private function createContentHtmlStart() {
		...
		if ( isset($this->pageVars["browser"]) && $this->pageVars["browser"] == "ie") {
				...
				<div class="playimg">
					...
					<div class="playimginner choicediv" id="p2choicediv">
						...
						<div class="row">
							<span class="lev1"> 
								<span class="lev2">
									<input type="radio" name="player2choice" id="p2radiopaper" value="paper" /> <span class="lev3"> Paper </span>
								</span>
								<span class="lev2">
									<img src="images/paper.png" alt="Paper" />
								</span>
						...
						<div class="row">
							<span class="lev1"> 
								<span class="lev2">
									<input type="radio" name="player2choice" id="p2radiorock" value="rock" /> <span class="lev3">  Rock </span>
								</span>
								<span class="lev2">
									<img src="images/stone.png" alt="Rock" />
								</span>
						...
						<div class="row">
							<span class="lev1"> 
								<span class="lev2">
									<input type="radio" name="player2choice" id="p2radiorock" value="scissors" /> <span class="lev3"> Scissors </span>
								</span>
								<span class="lev2">
									 <img src="images/scissors.png" alt="Scissors" />
								</span>
